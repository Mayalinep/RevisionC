...
/*   Updated: 2024/05/23 16:44:35 by mpelage          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    result = ft_memchr(str, ch, len);
    if (result != NULL)
        printf("Le caractère '%c' a été trouvé dans les %ld premiers caractères à la position : %ld\n", ch, len, (char *)result - str);
    else
        printf("Le caractère '%c' n'a pas été trouvé dans les %ld premiers caractères.\n", ch, len);
