...
/*   Updated: 2024/04/21 20:17:52 by maya             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    ...
    printf("dst : %s\n", dst);  // This may print garbage or cause a crash due to uninitialized data

    memcpy(dst, src, sizeof(src));

    printf("After memcpy:\n");
    printf("src : %s\n", src);  // Display the source array again
    printf("dst : %s\n", dst);  // Now this should print "Hello, GPT!" just like src
